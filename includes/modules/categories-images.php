...
function z_edit_texonomy_field($taxonomy) {
	...
	echo '<tr class="form-field">
		...
		<td><img class="taxonomy-image" style="width: 100%;" src="' . z_taxonomy_image_url( $taxonomy->term_id, NULL, TRUE ) . '"/><br/><input type="text" name="taxonomy_image" id="taxonomy_image" value="'.$image_text.'" /><br />
		<button class="z_upload_image_button button">' . __('上传/添加图像', 'zci') . '</button>
