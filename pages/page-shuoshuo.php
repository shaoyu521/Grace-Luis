...
<div class="page-single" >
	<div class="page-title" style="background-image:url(<?php echo suxingme('weiyu_banner_pic');?>);">
		<div class="container">
			<h1 class="title">
				<?php the_title(); ?>
			</h1>
    ...
    <main id="main" class="site-main" role="main">
        <div id="shuoshuo_content">
            <ul class="cbp_tmtimeline">
                ...
                <li> <span class="shuoshuo_author_img"><img src="<?php echo suxingme('wytx');  ?>" class="avatar avatar-48" width="48" height="48"></span>
